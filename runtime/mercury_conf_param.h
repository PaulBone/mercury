...
** MR_PARALLEL_PROFILING and must be enabled at runtime with the
...
/*
** Check that MR_PARALLEL_PROFILING is used correctly.
*/
#if defined(MR_PARALLEL_PROFILING) && !defined(MR_THREAD_SAFE)
